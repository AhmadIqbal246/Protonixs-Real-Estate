              ...
              <ScrollReveal key={property.id} delay={index * 80} variant="fade-up">
                <Link href={`/listings/${property.slug}`} className="group block cursor-pointer">
                  <div className="relative mb-5 aspect-[4/3] overflow-hidden bg-surface">
                    ...
                    <p className="absolute bottom-4 left-4 text-[10px] font-medium uppercase tracking-[0.18em] text-accent">
                      {property.tag}
                    </p>
                  </div>
